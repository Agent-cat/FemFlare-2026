  ...
  return (
    <section className="hero-section relative w-full h-[100dvh] bg-gradient-to-br from-[#ec4899] via-[#f43f5e] to-[#f97316] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Floating glass orbs */}
        {[
          { size: 'w-14 h-14 md:w-24 md:h-24', left: '8%',  top: '18%', delay: 0,   dur: 12, mob: true },
          { size: 'w-10 h-10 md:w-16 md:h-16', left: '82%', top: '12%', delay: 2,   dur: 14, mob: true },
          { size: 'w-12 h-12',                  left: '68%', top: '55%', delay: 4,   dur: 10, mob: false },
          { size: 'w-12 h-12 md:w-20 md:h-20', left: '22%', top: '68%', delay: 1,   dur: 16, mob: true },
          { size: 'w-8 h-8 md:w-10 md:h-10',   left: '92%', top: '42%', delay: 3,   dur: 11, mob: true },
          { size: 'w-14 h-14',                  left: '48%', top: '25%', delay: 5,   dur: 13, mob: false },
        ].map((orb, i) => (
          <div
            key={`orb-${i}`}
        ...
        {[
          ...
          <div
            ...
            style={{ left: d.left, top: d.top, animation: `anim-diamond ${d.dur}s ease-in-out ${d.delay}s infinite` }}
          />
        ))}
        ...
        {[
          ...
          <svg
            ...
            width={star.size} height={star.size} viewBox="0 0 24 24" fill="white"
          >
        ...
        {[
          ...
          <svg
            ...
            width={sparkle.size} height={sparkle.size} viewBox="0 0 24 24" fill="white"
          >
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-y-3 md:gap-y-0 px-6 sm:px-10 md:px-16 lg:px-20 py-2 md:py-0">
          ...
          >
            <div className="bg-white border-[3px] border-black p-6 sm:p-8 flex flex-col items-center justify-center aspect-square shadow-[8px_8px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-[transform,box-shadow] duration-200 min-w-[150px] sm:min-w-[180px]">
              ...
              <span className="text-xl sm:text-3xl font-black tracking-[0.05em] text-black uppercase font-quicksand mt-1">MARCH</span>
