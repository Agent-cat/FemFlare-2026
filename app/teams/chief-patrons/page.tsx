...
export const metadata: Metadata = {
  title: 'Chief Patrons | FemFlare 2026',
};

const chiefPatrons = [
  {
    name: "Smt. Koneru Siva Kanchana Latha",
    role: "Hon'ble Secretary, KLEF",
    image: "/chief%20patrons/Smt.%20KONERU%20SIVA%20KANCHANA%20LATHA.jpg"
  },
  {
    name: "Smt. Koneru Nikhila",
    role: "Founder & Joint Managing Director, Leap India Film Producer & Hon'ble Member, KLEF",
    image: "/chief%20patrons/Smt.%20KONERU%20NIKHILA.jpg"
  },
  {
    name: "Smt. Koneru Sri Divya",
    role: "Hon'ble Member, KLEF",
    image: "/chief%20patrons/Smt.%20Koneru%20Sri%20Divya.jpg"
  }
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col items-center justify-center mb-16 text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg md:text-xl font-medium">
               The visionaries and guiding forces behind FemFlare 2026.
            </p>
        </div>

        <TeamGrid members={chiefPatrons} />
      </div>
    </main>
  );
}
